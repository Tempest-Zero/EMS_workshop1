...
export function EmptyState({ icon: Icon, title, sub, className = "" }) {
  return (
    <div
      className={`flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-slate-300 bg-slate-50/60 px-6 py-12 text-center ${className}`}
    >
...
const variants = {
  ...
  outlineDanger:
    "bg-white text-red-600 ring-1 ring-inset ring-red-200 hover:bg-red-50 focus-visible:ring-red-300",
};
const sizes = {
