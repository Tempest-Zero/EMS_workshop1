...
import { attendance, monthSummary } from "@features/attendance/data/attendance";
import { spanBetween, elapsedSince, parseISO } from "@shared/lib/date";
                    ...
                    <div className="flex w-40 shrink-0 items-center gap-2 pr-2">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[10px] text-slate-400">
                          {sum.present}/{sum.working} present
                        </div>
                      </div>
                    </div>
