...
We use SQLAlchemy 2.0's `async_engine_from_config` and run migrations through
...
# Override the placeholder URL in alembic.ini with the live app config.
...
def run_migrations_offline() -> None:
    """Emit raw SQL for a URL — no engine required."""
