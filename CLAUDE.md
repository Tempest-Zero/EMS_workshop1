...
| **Backend** (`backend/`)                           | **FastAPI** (Python 3.12), SQLAlchemy 2.0 **async** + asyncpg, **Alembic** migrations (head = **0034**; 37 tables), Pytest + pytest-asyncio, Ruff, Mypy strict, import-linter                                                                                                                                                                | not Django, not sync SQLAlchemy                                                                           |
...
**Backend slices** (migrations 0020–0034 grew the operational store into a 37-table data
