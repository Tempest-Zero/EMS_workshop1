...
| **Backend** (`backend/`)                           | **FastAPI** (Python 3.12), SQLAlchemy 2.0 **async** + asyncpg, **Alembic** migrations (head = **0018**), Pytest + pytest-asyncio, Ruff, Mypy strict, import-linter                                                                                                                                                                           | not Django, not sync SQLAlchemy                                                                           |
